...
public class offersAdapter extends FirebaseRecyclerAdapter<
        Design, offersAdapter.MyViewHolder> {


    private FirebaseDatabase database;
    public DatabaseReference myRef;

    public offersAdapter(@NonNull FirebaseRecyclerOptions<Design> options){
        super(options);
    }
    @NonNull
    @Override
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : designers) {
                    if (model.offer.equals("yes") && model.approved.equals("no") ) {
